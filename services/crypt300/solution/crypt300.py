...
# Original Code with Factors

import sys

f = 'tesseract2014{EnigmaIsQuiteAnEnigmaLikeKryptos}'
...
msgs = [
    'Salt is Key!!!',
    'Uranus holds secrets.',
    'This is quite an enigma.',
    'They did it in 1999.',
    'Herman te Riele knows.',
    'It should take you less time than it took them.',
    '140! 140! 140!',
    'The quick brown fox jumped over the lazy dog. It really did indeed.',
]
